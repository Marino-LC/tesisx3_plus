...
def generate_launch_description():
    ...
    set_gz_model_path = SetEnvironmentVariable(name='GZ_SIM_RESOURCE_PATH', value=workspace_install_dir)
    ...
    spawn_entity = Node(
        package='ros_gz_sim',
        executable='create',
        arguments=['-topic', 'robot_description', '-name', 'omni_dofbot', '-z', '0.1'],
        output='screen'
    )
    ...
    # ================= RETORNO CON ENCADENAMIENTO SECUENCIAL =================
    return LaunchDescription([
        ...
        # Iniciar JSB solo cuando el robot hace spawn
        ...
        # Iniciar el Brazo solo cuando el JSB termina de cargar
        RegisterEventHandler(
            event_handler=OnProcessExit(
        ...
        # Iniciar el Gripper solo cuando el Brazo termina
        RegisterEventHandler(
            event_handler=OnProcessExit(
        ...
        # Finalmente, iniciar las ruedas cuando el Gripper termina
        RegisterEventHandler(
            event_handler=OnProcessExit(
